...
namespace SapSoapCardWriter.Logger.Logging.Log4Net
{
    /// <summary>
    ...
    {
        private const string LoggerName = "SapSoapCardWriter.Logger.Logging.Log4Net.Logger";
        private const string LogEventLoggerName = "SapSoapCardWriter.Logger.Logging.Log4Net.LogEventLogger";
